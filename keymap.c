 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   A  |ALT_S |CTL_D |SFT_F |   G  |-------.    ,-------|SFT_H |CTL_J |ALT_K |   L  |   '  |  ;   |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,   KC_A, LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,                     RSFT_T(KC_H),    RCTL_T(KC_J), RALT_T(KC_K), KC_L, KC_QUOT, KC_SCLN,
  KC_LSFT,  LGUI_T(KC_Z),   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  RGUI_T(KC_DOT), KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_TAB, LT(_LOWER, KC_BSPC), KC_ENT,      KC_SPC,  LT(_RAISE, KC_DEL), KC_ESC, KC_RCTL, KC_RGUI
),
/*
 * QWERTY_PLAIN
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_INS,  KC_PSCR, KC_APP,  XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC,
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |QK_BOOT|     |QWERTY|PLAIN |CGTOGG|      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |CGTOGG|      |      |      |-------.    ,-------|      | VOLD | MUTE | VOLU |      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      | PREV | PLAY | NEXT |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      |      |      |      | /       /       \      \  |      |      |      |      |
 ...
 */
  ...
  QK_BOOT  , XXXXXXX,KC_QWERTY,KC_QWERTY_PLAIN,CG_TOGG,XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
